...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__block__ = __webpack_require__(3);
...
/* harmony export (immutable) */ __webpack_exports__["d"] = gameOverDisplay;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = introDisplay;
...
class GameView {
  ...
  handleGameOver(t){
    if(this.gameOver) {
      clearTimeout(t);
      __WEBPACK_IMPORTED_MODULE_1__util__["d" /* gameOverDisplay */](this.ctx);
    }
  }
  ...
  start(){
    ...
    __WEBPACK_IMPORTED_MODULE_1__util__["e" /* introDisplay */](this.ctx);
  }
}
