...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_sound__ = __webpack_require__(2);
...
/* harmony export (immutable) */ __webpack_exports__["e"] = gameOverDisplay;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = introDisplay;
...
const displayPauseButton = (ctx, mute) => {
  ...
  if (mute){
    ctx.drawImage(base_image, 850, 5, 40, 40);
  } else {
    ctx.drawImage(base_image2, 850, 5, 40, 40);
  }

}
/* harmony export (immutable) */ __webpack_exports__["d"] = displayPauseButton;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = isOutOfBounds;
...
class GameView {
  ...
  checkBound(){
    this.gameOver = __WEBPACK_IMPORTED_MODULE_1__util__["b" /* isOutOfBounds */](this.player);
  }
  ...
  gameLoop(){
    ...
    this.drawBlocks();
    this.drawSprite();
    __WEBPACK_IMPORTED_MODULE_1__util__["c" /* displayScore */](this.ctx, this.player);
    __WEBPACK_IMPORTED_MODULE_1__util__["d" /* displayPauseButton */](this.ctx, this.mute);
  ...
  handleGameOver(t){
    if(this.gameOver) {
      ...
      this.audio.mute();
      __WEBPACK_IMPORTED_MODULE_1__util__["e" /* gameOverDisplay */](this.ctx);
    }
  }
  ...
  start(){
    ...
    this.audio.play(this.mute);
    __WEBPACK_IMPORTED_MODULE_1__util__["f" /* introDisplay */](this.ctx);
  }
}
