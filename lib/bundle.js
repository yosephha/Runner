...
const generateEnemy = () => {
  return new __WEBPACK_IMPORTED_MODULE_1__enemy__["a" /* default */](
    "assets/images/bird_sprite1.png",
    300, 180, 50, 50
  );
}
/* harmony export (immutable) */ __webpack_exports__["a"] = generateEnemy;
...
class GameView {
  ...
  initialVal(){
    ...
    this.enemy = __WEBPACK_IMPORTED_MODULE_1__util__["a" /* generateEnemy */]();
    this.gameOver = false;
    ...
    __WEBPACK_IMPORTED_MODULE_1__util__["b" /* generatePlatforms */](this.block, this.blockHeight);
  }
  ...
  drawEnemy(){
    ...
    this.ctx.drawImage(
      ...
      this.enemy.X, this.enemy.Y, 100, 50)
  }
