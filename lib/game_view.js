...
class GameView {
  ...
  gameLoop(){
    ...
    block.forEach(blk => blk.X += -player.velocity_x - this.difficulty) //multiply block_v for level up
  ...
  gameOverDisplay(){ //take to util
    ...
    base_image1.src = 'assets/game-over-blk.png';
    base_image1.onload = () => {
      this.ctx.drawImage(base_image1, 90, 10, 700, 300);
    }

    let base_image2 = new Image();
    base_image2.src = 'assets/space-bar-continue.png';
  ...
  introDisplay(){ //take to util
    let base_image2 = new Image();
    base_image2.src = 'assets/start-page.png';
  ...
  initialVal(){
    ...
    this.player.weight = 0.1; //incriment for level up +0.01
